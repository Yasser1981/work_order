...
EXCEL_LABOUR = [
    ...
    "نصب عمود مشبك 14م (مزدوج)",
    "نصب ركيزة وسطية (مزدوج)",
    "نصب ركيزة بداية ونهاية (مزدوج)",
    "نصب عمود مشبك 14م (مفرد)",
    "نصب ركيزة وسطية (مفرد)",
    "نصب ركيزة بداية ونهاية (مفرد)",
    "تسليك شبكة 33 ك.ف 210",
    "نصب فاصل هوائي 33 ك.ف",
    "كلفة مد القابلو 33 ك.ف",
    "كلفة مد القابلو 11 ك.ف",
    "كلفة نصب صندوق مستقيم 33 ك.ف",
    "كلفة نصب صندوق نهاية 33 ك.ف",
    "كلفة نصب صندوق مستقيم 11 ك.ف",
    "كلفة نصب صندوق نهاية 11 ك.ف",
]
...
MERGED = {
    ...
    "نصب عمود مشبك 14م (مزدوج)": "نصب عمود مشبك 14م",
    "نصب عمود مشبك 14م (مفرد)": "نصب عمود مشبك 14م",
    "نصب ركيزة وسطية (مزدوج)": "نصب ركيزة شد وسطية",
    "نصب ركيزة وسطية (مفرد)": "نصب ركيزة شد وسطية",
    "نصب ركيزة بداية ونهاية (مزدوج)": "نصب ركيزة شد بداية ونهاية",
    "نصب ركيزة بداية ونهاية (مفرد)": "نصب ركيزة شد بداية ونهاية",
}
