    ...
    **الفارق الجوهري عن لوحة الشبكة:** الأعمدة هنا **قائمة على الأرض** لا
    ...
    def refresh_hints(self) -> None:
        ...
        self.increment_hint.setText(
            ...
            + " &nbsp;·&nbsp; ".join(parts)
            + "<br>والعوازل: <b>+4 دبوسي</b> لكل مدوّر (3 للدائرة + 1 بدل تاج)، "
            "و<b>+8 قرصي</b> لكل مشبك (6 + 2 بدل تاج)، و<b>+6 معدات ربط</b>."
            "<br>وتركيب البراكيت والعوازل على العمود القائم <b>بلا أجر</b> — "
            "الأجر للتسليك ولنصب الأعمدة المضافة وحدهما."
        )
