...
class PricesWindow(QDialog):
    ...
    def _build(self) -> None:
        ...
        layout.addWidget(HintLabel(
            ...
            "أصله، فحرِّر الأصل ويتبعه المشتقّ (ق-٥٨).<br>"
            "<b>وإن كنت تعمل على أكثر من حاسبة:</b> النسخة الجديدة تُنشأ على "
            "<b>هذه الحاسبة وحدها</b>، فتختلف أسعار الحاسبتين. ولتبقيا متطابقتين "
            "بلا مزامنة، اجعل الأسعار الجديدة تصل مع البرنامج نفسه (ق-٧٥)."
        ))
