...
M_AL_FITTINGS_33 = ("معدات ربط ألمنيوم – ألمنيوم 210 ملم²", "عدد")
M_BRACKET_12 = ("براكيت جنل 1.2 م مع الملحقات", "عدد")
M_BRACKET_14 = ("براكيت جنل 1.4 م مع الملحقات", "عدد")
M_BRACKET_2 = ("براكيت جنل 2 متر", "عدد")
M_BRACKET_25 = ("براكيت جنل 2.5 متر", "عدد")
...
CONVERSION_LATTICE_RATE = "تحويل عمود مشبك 11م من مفرد إلى مزدوج"
CONVERSION_ROUND_RATE = "تحويل عمود مدوّر 11م من مفرد إلى مزدوج"
"""بندا أجر تحويل العمود القائم (ق-٨٣) — **بلا سعر في نسخة الأسعار بعد**.

بنصّ المستخدم: «اتركه فارغاً حالياً بدون أجور». فيُقرأ سعرهما بـ`.get` لا
بالفهرسة، ويخرجان بنداً «بلا أجر» على قاعدة ق-٩ — فيبقى العمل مرئياً ويُنبَّه
عليه، ولا ينهار الحساب على نسخة أسعار لا تعرفهما.

وبندان لا بند واحد: عمل المشبك (4 براكيت و6 عوازل قرصية) غير عمل المدوّر
(براكيتان)، فسعرٌ واحد لهما يخفي فرقاً حقيقياً.
"""
